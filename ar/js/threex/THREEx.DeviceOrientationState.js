...
THREEx.DeviceOrientationState   = function()
{
        ...
        this._camera_rotation = { x: 0, y: 0, z: 0 };
        this._found_state     = { x: 0, y: 0, z: 0 };
...
THREEx.DeviceOrientationState.prototype.setState  = function()
{
        this._found_state.x=this._state.x;
        this._found_state.y=this._state.y;
        this._found_state.z=this._state.z;
}
